        ...
        private DataTemplate GetRecipeCollectionItemTemplate()
        {
            return new DataTemplate
            {
                LoadTemplate = () =>
                {
                    ...
                    var contentGrid = new Grid();
                    var recipeItemTemplateImage = GetImage();
                    contentGrid.Children.Add(recipeItemTemplateImage);

                    var imageOverlay = GetImageOverlay();
                    contentGrid.Children.Add(imageOverlay);

                    var foodTypeFrame = GetFoodTypeFrame();
                    contentGrid.Children.Add(foodTypeFrame);

                    dataTemplateRoot.Content = contentGrid;
